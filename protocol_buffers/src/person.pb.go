...
type SocialFollowers struct {
	...
	Github        int32                  `protobuf:"varint,1,opt,name=github,proto3" json:"github,omitempty"`
...
func (x *SocialFollowers) GetGithub() int32 {
	if x != nil {
		return x.Github
	}
	return 0
...
const file_person_proto_rawDesc = "" +
	"\n" +
	"\fperson.proto\x12\x04main\"C\n" +
	"\x0fSocialFollowers\x12\x16\n" +
	"\x06github\x18\x01 \x01(\x05R\x06github\x12\x18\n" +
	"\atwitter\x18\x02 \x01(\x05R\atwitter\"o\n" +
	"\x06Person\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03age\x18\x02 \x01(\x05R\x03age\x12?\n" +
	"\x0fsocialFollowers\x18\x03 \x01(\v2\x15.main.SocialFollowersR\x0fsocialFollowersB\tZ\a./;mainb\x06proto3"
